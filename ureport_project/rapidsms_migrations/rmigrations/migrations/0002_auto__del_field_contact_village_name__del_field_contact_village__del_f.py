...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.village_name'
        db.delete_column('rapidsms_contact', 'village_name')

        # Deleting field 'Contact.village'
        db.delete_column('rapidsms_contact', 'village_id')

        # Deleting field 'Contact.subcounty'
        db.delete_column('rapidsms_contact', 'subcounty_id')
    ...
    def backwards(self, orm):
        # Adding field 'Contact.village_name'
        db.add_column('rapidsms_contact', 'village_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.village'
        db.add_column('rapidsms_contact', 'village',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='villagers', null=True, to=orm['locations.Location'], blank=True),
                      keep_default=False)

        # Adding field 'Contact.subcounty'
        db.add_column('rapidsms_contact', 'subcounty',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subcounties', null=True, to=orm['locations.Location'], blank=True),
                      keep_default=False)
